...
CREATE
OR REPLACE TABLE ROLAND1.CUSMST (
  ...
  CONSTRAINT ROLAND1.CUSMST_PK PRIMARY KEY(CUSNUM)
) RCDFMT CUSREC;

LABEL ON TABLE ROLAND1.CUSMST IS 'PC Support Customer File';

LABEL ON COLUMN ROLAND1.CUSMST (
